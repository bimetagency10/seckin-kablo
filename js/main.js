...
(function () {
  ...
  if (!document.querySelector('.wa-float')) {
    ...
    wa.href = 'https://wa.me/905372976545?text=Merhaba,%20Se%C3%A7kin%20Kablo%20%C3%BCr%C3%BCnleri%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum.';
    wa.target = '_blank';
    wa.rel = 'noopener';
    wa.setAttribute('aria-label', 'WhatsApp ile iletişime geçin');
    wa.setAttribute('data-event', 'whatsapp');
    wa.innerHTML =
