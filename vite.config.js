  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        'solar-kablolari': resolve(__dirname, 'solar-kablolari.html'),
        'pur-kablolari': resolve(__dirname, 'pur-kablolari.html'),
        'yangina-dayanikli-kablolar': resolve(__dirname, 'yangina-dayanikli-kablolar.html'),
